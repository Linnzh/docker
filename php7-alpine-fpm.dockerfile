...
ENV PHPIZE_DEPS="freetype-dev libjpeg-turbo-dev libpng-dev libwebp-dev libzip-dev icu-dev libxml2-dev imagemagick-dev zstd-libs zstd-libs"
# 需要使用 docker-php-ext-install 安装的扩展
# gd 所需依赖：freetype-dev libjpeg-turbo-dev libpng-dev libwebp-dev libzip-dev
# intl 所需依赖：icu-dev
